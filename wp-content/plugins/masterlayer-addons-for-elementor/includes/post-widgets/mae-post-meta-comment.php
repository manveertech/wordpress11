...
class MAE_Post_Meta_Comment_Widget extends Widget_Base{
    ...
    public function get_name() {
        return 'mae-post-meta-comment';
    }

    // The get_title() method, which again, is a very simple one, you need to return the widget title that will be displayed as the widget label.
    public function get_title() {
        return __( 'MAE - Post Meta (Comments)', 'masterlayer' );
    }
	...
	protected function render() {
        ...
        if ( get_post_type() == 'elementor_library' ) { ?>
            <span class="master-post-meta post-comment"><?php echo $icon; ?><?php echo __('1 Comment', 'masterlayer'); ?></span>
        <?php } else {
            if ( comments_open() || get_comments_number() ) { ?>
                <span class="master-post-meta post-comment">
                <?php echo $icon; ?>
                <?php comments_popup_link( 
                    esc_html__( '0 comments', 'masterlayer' ), 
                    esc_html__( '1 Comment', 'masterlayer' ), 
                    esc_html__( '% Comments', 'masterlayer' ) ); ?>
                </span>
            <?php }
        }
    }
