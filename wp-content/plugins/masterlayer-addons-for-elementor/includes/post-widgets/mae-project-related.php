...
class MAE_Project_Related_Widget extends Widget_Base {
    ...
    public function get_name() {
        return 'mae-project-related';
    }

    // The get_title() method, which again, is a very simple one, you need to return the widget title that will be displayed as the widget label.
    public function get_title() {
        return __( 'MAE - Related Projects', 'masterlayer' );
    }
        ...
        // Color
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selectors' => '{{WRAPPER}} .master-project .content-wrap',
                    'fields_options' => [
    ...
    protected function render() {
        ...
        if ( ! $query->have_posts() ) { esc_html_e( 'No related projects!', 'masterlayer' ); return; }
