...
class MAE_Post_Meta_Category_Widget extends Widget_Base{
    ...
    public function get_name() {
        return 'mae-post-meta-category';
    }

    // The get_title() method, which again, is a very simple one, you need to return the widget title that will be displayed as the widget label.
    public function get_title() {
        return __( 'MAE - Post Meta (Categories)', 'masterlayer' );
    }
	...
	protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .master-post-meta a:hover' => 'color: {{VALUE}};',
                ]
            ]
        );
	...
	protected function render() {
        ...
        if ( get_post_type() == 'elementor_library' ) { ?>
            <span class="master-post-meta post-meta-categories item"> 
                <?php 
                echo $icon;
                echo $settings['prefix_text']; 
                echo __( 'Uncategorized', 'masterlayer' ); ?>
            </span>
        <?php } else { ?>
