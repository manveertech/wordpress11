...
class MAE_Cart_Icon_Widget extends Widget_Base {
    ...
    public function get_title() {
        return __( 'MAE - Cart Icon', 'masterlayer' );
    }
    ...
    protected function register_controls() {
        // Content
            ...
            $this->add_responsive_control(
                'cart_height',
                [
                    'label'      => __( 'Cart Height', 'masterlayer' ),
                    ...
                    'selectors'  => [
                        '{{WRAPPER}} .congin-cart .nav-cart-trigger' => 'line-height: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
                    ],
                    50,
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px' ],
                    'selectors' => [
                        '{{WRAPPER}} .congin-cart i' => 'font-size: {{SIZE}}{{UNIT}};',
                        '{{WRAPPER}} .congin-cart svg' => 'width: {{SIZE}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .congin-cart .nav-cart-trigger' => 'color: {{VALUE}};',
                    ],
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .congin-cart:hover .nav-cart-trigger' => 'color: {{VALUE}};',
                    ],
                ]
            );
