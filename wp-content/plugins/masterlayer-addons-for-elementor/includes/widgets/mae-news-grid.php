...
class MAE_News_Grid_Widget extends Widget_Base {
    ...
    public function get_title() {
        return __( 'MAE - News Grid', 'masterlayer' );
    }
        ...
        // News
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type'    => Controls_Manager::TEXT,
                    'placeholder' => __( 'Ex: F j, Y', 'masterlayer' ),
                    'condition' => ['meta_date' => 'true']
                ]
            );
                    ...
                    <?php while ( $query->have_posts() ) : $query->the_post(); 
                        ...
                        <div class="master-news cbp-item">
                            ...
                            echo '<div class="image-wrap">';
                                echo $image;
                                if ( $settings['style'] == 'style-2' ) echo $post_date;
                            echo '</div>';

                            echo '<div class="content-wrap">';
                                if ( $settings['style'] == 'style-1' ) echo $post_date;
                                echo $metas;
                                echo $title;
    ...
    public function render_meta() {
        $settings = $this->get_settings_for_display();
        $date_fortmat = 'F j, Y';
        if ( $settings['meta_date_format'] ) $date_fortmat = $settings['meta_date_format'];
        ob_start(); 
            echo '<div class="post-meta">';

            if ($settings['meta_date'] == 'true') {
                printf( '<span class="post-date item">%1$s</span>',
                    get_the_date($date_fortmat)
                );
            }
            ...
            if ($settings['meta_cat'] == 'true') {
                echo '<span class="post-meta-categories item">' . 
                    esc_html( congin_get_mod( 'blog_before_category', '' ) ) . ' ';
