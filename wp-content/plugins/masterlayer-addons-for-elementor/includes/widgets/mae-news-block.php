...
class MAE_News_Block_Widget extends Widget_Base {
    ...
    public function get_title() {
        return __( 'MAE - Latest News List', 'masterlayer' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'posts_per_page',
            [
                'label' => __( 'Posts per Page', 'masterlayer' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .master-news .post-meta .item a' => 'color: {{VALUE}};',
                ]
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .master-news .post-meta .item a:hover' => 'color: {{VALUE}};',
                ]
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .master-news .thumb' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                ],
            ]
        );  
    ...
    protected function render() {
        ...
        if ( $settings['posts_per_page']['size'] ) $ppp = $settings['posts_per_page']['size'];
