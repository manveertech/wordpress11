...
class MAE_Button_Popup_Widget extends Widget_Base {
    ...
    public function get_name() {
        return 'mae-button-popup';
    }

    // The get_title() method, which again, is a very simple one, you need to return the widget title that will be displayed as the widget label.
    public function get_title() {
        return __( 'MAE - Button Popup', 'masterlayer' );
    }
    ...
    protected function register_controls() {
        ...
        // Popup
            $this->start_controls_section( 'content_section_popup',
                [
                    'label' => __( 'Popup', 'masterlayer' ),
                ]
            );
    ...
    protected function render() {
        ...
        <div class="master-popup">
            <a class="master-button popup-btn <?php echo esc_attr($cls); ?>">
            ...
            <div class="popup-panel">
                ...
                <span class="close-btn ci-close"></span>
                <div class="popup-content">
                    <?php if ($settings['content_type'] == 'content') {
                        echo $settings['popup_content']; 
                    } else {
                        if (!empty($settings['popup_template'])) {
                            echo Plugin::$instance->frontend->get_builder_content($settings['popup_template'], false);
                        }
                    } ?>
                </div>
            </div>
