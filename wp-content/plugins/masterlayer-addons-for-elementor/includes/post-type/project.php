...
// Register Excerpt
function mae_register_project_excerpts() {
    add_post_type_support( 'project', 'excerpt' ); //change page with your post type slug.
}

add_action( 'init', 'mae_register_project_excerpts' );
