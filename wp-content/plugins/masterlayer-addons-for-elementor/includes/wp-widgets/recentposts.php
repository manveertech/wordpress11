            ...
            while ( $query->have_posts() ) : $query->the_post(); ?>
				<li class="clearfix" style="<?php echo esc_attr( $item_css ); ?>">
                    ...
                    if ( $before_author == 'show' ) {
                        printf( '<div class="post-meta"><span class="post-by-author item"><a class="name" href="%1$s" title="%2$s">%3$s</a></span></div>',
                    ...
                    if ( $after_date == 'show' ) {
                        printf( '<div class="post-meta"><span class="post-date item"><span class="entry-date">%1$s</span></span></div>',
                            get_the_date()
                        );
                    }
...
add_action( 'widgets_init', 'mae_register_recent_news' );

// Register widget
function mae_register_recent_news() {
