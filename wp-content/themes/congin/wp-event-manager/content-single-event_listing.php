    ...
    <div class="wpem-main wpem-single-event-page">
        ...
        if ( congin_get_elementor_option('event_builder') == 'yes' ) {
            ...
            if (get_option('event_manager_hide_expired_content', 1) && 'expired' === $post->post_status) : ?>
                <div class="wpem-alert wpem-alert-danger"><?php _e('This listing has been expired.', 'congin'); ?></div>

            <?php else : ?>
                <?php if (is_event_cancelled()) : ?>
                    <div class="wpem-alert wpem-alert-danger">
                        <span class="event-cancelled"><?php _e('This event has been cancelled.', 'congin'); ?></span>
                    </div>
                <?php elseif (!attendees_can_apply() && 'preview' !== $post->post_status) : ?>
                    <div class="wpem-alert wpem-alert-danger">
                        <span class="listing-expired"><?php _e('Registrations have closed.', 'congin'); ?></span>
                    </div>
                <?php endif; ?>
                <?php
                /**
                            ...
                            <div class="wpem-col-xs-12 wpem-col-sm-7 wpem-col-md-8 wpem-single-event-left-content">
                                <div class="wpem-single-event-short-info">
                                    <div class="wpem-event-details">
                                        ...
                                        <?php if (get_option('enable_event_organizer')) : ?>
                                            <div class="wpem-event-organizer">
                                                <div class="wpem-event-organizer-name">
                                                    ...
                                                    <?php printf(__('by %s', 'congin'), get_organizer_name($post, true)); ?>
                                        ...
                                        if ($view_count) :
                                        ?>
                                            <div class="wpem-viewed-event wpem-tooltip wpem-tooltip-bottom"><i class="wpem-icon-eye"></i><?php printf(__(' %d', 'congin'), $view_count); ?>
                                                <span class="wpem-tooltiptext"><?php printf(__('%d people viewed this event.', 'congin'), $view_count); ?></span>
                                            </div>
                                        <?php endif; ?>
                                    ...
                                    if (!empty($additional_fields)) : ?>
                                        <div class="wpem-additional-info-block-wrapper">
                                            ...
                                            <div class="wpem-additional-info-block">
                                                <h3 class="wpem-heading-text"><?php _e('Additional Details', 'congin'); ?></h3>
                                            </div>
                                                    ...
                                                    foreach ($additional_fields as $name => $field) : ?>
                                                        ...
                                                        <?php if (isset($field_value)) : ?>
                                                            ...
                                                            <?php if ($field['type'] == 'group') : ?>
                                                                ...
                                                                <?php if (isset($field['fields']) && !empty($field['fields'])) : ?>
                                                                    ...
                                                                    <div class="wpem-col-12 wpem-additional-info-block-group">
                                                                        ...
                                                                        <p class="wpem-additional-info-block-title"><strong><?php echo esc_html($field['label']); ?></strong></p>
                                                                            ...
                                                                            <?php foreach ($field['fields'] as $child_field_name => $child_field) : ?>
                                                                                ...
                                                                                <?php if (!empty($child_value[$child_field_name])) : ?><div class="wpem-col-md-6 wpem-col-sm-12 wpem-additional-info-block-details-content-left">
                                                                                        <div class="wpem-additional-info-block-details-content-items"> <?php
                                                                                                                                                        ...
                                                                                                                                                        ?>
                                                                                            <p class="wpem-additional-info-block-title"><strong><?php printf(__('%s', 'congin'),  $child_field['label']); ?> -</strong> <?php printf(__('%s', 'congin'),  implode(', ', $my_value_arr)); ?></p>
                                                                                        </div>
                                                                                    </div>
                                                                                <?php elseif ($child_field['type'] == 'select') : ?>
                                                                                    <div class="wpem-col-md-6 wpem-col-sm-12 wpem-additional-info-block-details-content-left">
                                                                                        <div class="wpem-additional-info-block-details-content-items">
                                                                                            <p class="wpem-additional-info-block-title"><strong><?php printf(__('%s', 'congin'),  $child_field['label']); ?> - </strong> <?php printf(__('%s', 'congin'),  $child_value[$child_field_name]); ?></p>
                                                                                        </div>
                                                                                    </div>
                                                                                    ...
                                                                                    <?php if ($child_field['type'] == 'textarea' || $child_field['type'] == 'wp-editor') : ?>
                                                                                        <div class="wpem-col-12 wpem-additional-info-block-textarea">
                                                                                            <div class="wpem-additional-info-block-details-content-items">
                                                                                                <p class="wpem-additional-info-block-title"><strong> <?php printf(__('%s', 'congin'),  $child_field['label']); ?></strong></p>
                                                                                                <p class="wpem-additional-info-block-textarea-text"><?php printf(__('%s', 'congin'),  $child_value[$child_field_name]); ?></p>
                                                                                            </div>
                                                                                        </div>
                                                                                    ...
                                                                                    <?php elseif ($child_field['type'] == 'date') : ?>
                                                                                        <div class="wpem-col-md-6 wpem-col-sm-12 wpem-additional-info-block-details-content-left">
                                                                                            <div class="wpem-additional-info-block-details-content-items">
                                                                                                <p class="wpem-additional-info-block-title"><strong><?php printf(__('%s', 'congin'),  $child_field['label']); ?> - </strong> <?php echo date_i18n($date_format, strtotime($child_value[$child_field_name])); ?></p>
                                                                                            </div>
                                                                                        </div>
                                                                                    <?php elseif ($child_field['type'] == 'time') : ?>
                                                                                        <div class="wpem-col-md-6 wpem-col-sm-12 wpem-additional-info-block-details-content-left">
                                                                                            <div class="wpem-additional-info-block-details-content-items">
                                                                                                <p class="wpem-additional-info-block-title"><strong><?php printf(__('%s', 'congin'),  $child_field['label']); ?> - </strong> <?php echo date($time_format, strtotime($child_value[$child_field_name])); ?></p>
                                                                                            </div>
                                                                                        </div>
                                                                                            ...
                                                                                            <div class="wpem-additional-info-block-details-content-items wpem-additional-file-slider">
                                                                                                <?php if (is_array($child_value[$child_field_name])) : ?>
                                                                                                    <?php foreach ($child_value[$child_field_name] as $file) : ?>
                                                                                                        ...
                                                                                                        <?php else : ?>
                                                                                                            <div class="wpem-icon"><a target="_blank" class="wpem-icon-download3" href="<?php echo esc_attr($file); ?>"> <?php _e('Download', 'congin'); ?></a></div>
                                                                                                        <?php endif; ?>
                                                                                                    <?php endforeach; ?>
                                                                                                <?php else : ?>
                                                                                                    ...
                                                                                                    <?php else : ?>
                                                                                                        <div class="wpem-icon"><a target="_blank" class="wpem-icon-download3" href="<?php echo esc_attr($child_value[$child_field_name]); ?>"> <?php _e('Download', 'congin'); ?></a></div>
                                                                                                    <?php endif; ?>
                                                                                                <?php endif; ?>
                                                                                            </div>
                                                                                        </div>
                                                                                    <?php elseif ($child_field['type'] == 'url') : ?>
                                                                                        <div class="wpem-col-12 wpem-additional-info-block-textarea">
                                                                                            <div class="wpem-additional-info-block-details-content-items">
                                                                                                <p class="wpem-additional-info-block-textarea-text"><a href="<?php if (isset($child_value[$child_field_name])) echo esc_url($child_value[$child_field_name]); ?>"><?php printf(__('%s', 'congin'),  $child_field['label']); ?></a></p>
                                                                                            </div>
                                                                                        </div>
                                                                                    <?php else : ?>
                                                                                        <?php if (is_array($child_value[$child_field_name])) : ?>
                                                                                            <div class="wpem-col-md-6 wpem-col-sm-12 wpem-additional-info-block-details-content-left">
                                                                                                <div class="wpem-additional-info-block-details-content-items">
                                                                                                    <p class="wpem-additional-info-block-title"><strong><?php echo esc_html($child_field['label']); ?> -</strong> <?php echo esc_html(implode(', ', $child_value[$child_field_name])); ?></p>
                                                                                                </div>
                                                                                            </div>
                                                                                        <?php else : ?>
                                                                                            <div class="wpem-col-md-6 wpem-col-sm-12 wpem-additional-info-block-details-content-left">
                                                                                                <div class="wpem-additional-info-block-details-content-items">
                                                                                                    <p class="wpem-additional-info-block-title"><strong><?php echo esc_html($child_field['label']); ?> -</strong> <?php echo esc_html($child_value[$child_field_name]); ?></p>
                                                                                                </div>
                                                                                            </div>
                                                                                        <?php endif; ?>
                                                            ...
                                                            <?php elseif ($field['type'] == 'textarea' || $field['type'] == 'wp-editor') : ?>
                                                                <div class="wpem-col-12 wpem-additional-info-block-textarea">
                                                                    <div class="wpem-additional-info-block-details-content-items">
                                                                        <p class="wpem-additional-info-block-title"><strong> <?php printf(__('%s', 'congin'),  $field['label']); ?></strong></p>
                                                                        <p class="wpem-additional-info-block-textarea-text"><?php printf(__('%s', 'congin'),  $field_value); ?></p>
                                                                    </div>
                                                                </div>
                                                            <?php elseif ($field['type'] == 'multiselect') : ?>
                                                                <div class="wpem-col-md-6 wpem-col-sm-12 wpem-additional-info-block-details-content-left">
                                                                    <div class="wpem-additional-info-block-details-content-items">
                                                                        ...
                                                                        ?>
                                                                        <p class="wpem-additional-info-block-title"><strong><?php printf(__('%s', 'congin'),  $field['label']); ?> -</strong> <?php printf(__('%s', 'congin'),  implode(', ', $my_value_arr)); ?></p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <?php elseif ($field['type'] == 'select') : ?>
                                                                <div class="wpem-col-md-6 wpem-col-sm-12 wpem-additional-info-block-details-content-left">
                                                                    <div class="wpem-additional-info-block-details-content-items">
                                                                        <p class="wpem-additional-info-block-title"><strong><?php printf(__('%s', 'congin'),  $field['label']); ?> - </strong> <?php
                                                                            if (isset($field['options'][$field_value]))
                                                                                printf(__('%s', 'congin'),  $field['options'][$field_value]);
                                                                            else
                                                                                printf(__('%s', 'congin'), $field_value);
                                                                            ?></p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <?php elseif (isset($field['type']) && $field['type'] == 'date') : ?>
                                                                <div class="wpem-col-md-6 wpem-col-sm-12 wpem-additional-info-block-details-content-left">
                                                                    <div class="wpem-additional-info-block-details-content-items">
                                                                        <p class="wpem-additional-info-block-title"><strong><?php printf(__('%s', 'congin'),  $field['label']); ?> - </strong> <?php echo date_i18n($date_format, strtotime($field_value)); ?></p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <?php elseif (isset($field['type']) && $field['type'] == 'time') : ?>
                                                                <div class="wpem-col-md-6 wpem-col-sm-12 wpem-additional-info-block-details-content-left">
                                                                    <div class="wpem-additional-info-block-details-content-items">
                                                                        <p class="wpem-additional-info-block-title"><strong><?php printf(__('%s', 'congin'),  $field['label']); ?> - </strong> <?php echo date($time_format, strtotime($field_value)); ?></p>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="wpem-additional-info-block-details-content-items wpem-additional-file-slider">
                                                                        <?php if (is_array($field_value)) : ?>
                                                                            <?php foreach ($field_value as $file) : ?>
                                                                                ...
                                                                                <?php else : ?>
                                                                                    <div class="wpem-icon">
                                                                                        <p class="wpem-additional-info-block-title"><strong><?php echo esc_html(wp_basename($file)); ?></strong></p>
                                                                                        <a target="_blank" class="wpem-icon-download3" href="<?php echo esc_url($file); ?>"> <?php _e('Download', 'congin'); ?></a>
                                                                                    </div>
                                                                                <?php endif; ?>
                                                                            <?php endforeach; ?>
                                                                        <?php else : ?>
                                                                            ...
                                                                            <?php else : ?>
                                                                                <p class="wpem-additional-info-block-title"><strong><?php echo esc_html(wp_basename($field_value)); ?></strong></p>
                                                                                <div class="wpem-icon"><a target="_blank" class="wpem-icon-download3" href="<?php echo esc_url($field_value); ?>"> <?php _e('Download', 'congin'); ?></a></div>
                                                                            <?php endif; ?>
                                                                        <?php endif; ?>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <?php elseif ($field['type'] == 'url') : ?>
                                                                <div class="wpem-col-12 wpem-additional-info-block-textarea">
                                                                    <div class="wpem-additional-info-block-details-content-items">
                                                                        <p class="wpem-additional-info-block-textarea-text"><a target="_blank" href="<?php if (isset($field_value)) echo esc_url($field_value); ?>"><?php printf(__('%s', 'congin'),  $field['label']); ?></a></p>
                                                                    </div>
                                                                </div>
                                                            <?php elseif ($field['type'] == 'radio' && array_key_exists('options',$field)) : ?>
                                                                <div class="wpem-col-md-6 wpem-col-sm-12 wpem-additional-info-block-details-content-left">
                                                                    <div class="wpem-additional-info-block-details-content-items">
                                                                        <p class="wpem-additional-info-block-title"><strong><?php echo esc_html($field['label']); ?> -</strong> <?php echo isset($field['options'][$field_value]) ? esc_html($field['options'][$field_value]) : ''; ?></p>
                                                                    </div>
                                                                </div>
                                                            <?php elseif ($field['type'] == 'term-checklist' && array_key_exists('taxonomy',$field)) : ?>
                                                                <div class="wpem-col-md-6 wpem-col-sm-12 wpem-additional-info-block-details-content-left">
                                                                    <div class="wpem-additional-info-block-details-content-items">
                                                                        <p class="wpem-additional-info-block-title"><strong><?php printf(__('%s', 'congin'),  $field['label']); ?> - </strong>
                                                                        <?php 
                                                                ...
                                                                <div class="wpem-col-12 wpem-additional-info-block-textarea">
                                                                    <div class="wpem-additional-info-block-details-content-items">
                                                                        <p class="wpem-additional-info-block-textarea-text">
                                                                            <strong><?php echo esc_html($field['label']); ?></strong> - <?php
                                                                            if ($field_value == 1) {
                                                                                echo esc_html("Yes");
                                                                            } else {
                                                                                echo esc_html("No");
                                                            ...
                                                            <?php else : ?>
                                                                <?php if (is_array($field_value)) : ?>
                                                                    <div class="wpem-col-md-6 wpem-col-sm-12 wpem-additional-info-block-details-content-left">
                                                                        <div class="wpem-additional-info-block-details-content-items">
                                                                            <p class="wpem-additional-info-block-title"><strong><?php echo esc_html($field['label']); ?> -</strong> <?php echo  esc_html(implode(', ', $field_value)); ?></p>
                                                                        </div>
                                                                    </div>
                                                                <?php else : ?>
                                                                    <div class="wpem-col-md-6 wpem-col-sm-12 wpem-additional-info-block-details-content-left">
                                                                        <div class="wpem-additional-info-block-details-content-items">
                                                                            <p class="wpem-additional-info-block-title"><strong><?php echo esc_html($field['label']); ?> -</strong> <?php echo esc_html($field_value); ?></p>
                                                                        </div>
                                                                    </div>
                                                                <?php endif; ?>
                                ...
                                <div class="wpem-single-event-body-sidebar">
                                   ...
                                   <?php
                                    ...
                                    if (attendees_can_apply() && ((strtotime($registration_end_date) >= $current_timestamp) || empty($registration_end_date)) && $registration_addon_form) {
                                        ...
                                        echo wp_kses_post('<div class="wpem-alert wpem-alert-warning">' . __('Event registration closed.', 'congin') . '</div>');
                                    }
                                    ?>
                                    ...
                                    <div class="wpem-single-event-sidebar-info">
                                        ...
                                        <h3 class="wpem-heading-text"><?php _e('Date And Time', 'congin') ?></h3>
                                        ...
                                        <?php if (get_event_registration_end_date()) : ?>
                                            <div class="clearfix">&nbsp;</div>
                                            <h3 class="wpem-heading-text"><?php _e('Registration End Date', 'congin'); ?></h3>
                                        ...
                                        <div>
                                            <div class="clearfix">&nbsp;</div>
                                            <h3 class="wpem-heading-text"><?php _e('Location', 'congin'); ?></h3>
                                            <div>
                                                <?php
                                        ...
                                        <?php if (get_option('event_manager_enable_event_types') && get_event_type($event)) : ?>
                                            <div class="clearfix">&nbsp;</div>
                                            <h3 class="wpem-heading-text"><?php _e('Event Types', 'congin'); ?></h3>
                                        ...
                                        if (get_option('event_manager_enable_categories') && get_event_category($event)) : ?>
                                            <div class="clearfix">&nbsp;</div>
                                            <h3 class="wpem-heading-text"><?php _e('Event Category', 'congin'); ?></h3>
                                        ...
                                        if (get_organizer_youtube($event)) : ?>
                                            <div class="clearfix">&nbsp;</div>
                                            <a id="event-youtube-button" data-modal-id="wpem-youtube-modal-popup" class="wpem-theme-button wpem-modal-button"><?php _e('Watch video', 'congin'); ?></a>
                                            <div id="wpem-youtube-modal-popup" class="wpem-modal" role="dialog" aria-labelledby="<?php _e('Watch video', 'congin'); ?>">
                                                <div class="wpem-modal-content-wrapper">
                                                    <div class="wpem-modal-header">
                                                        <div class="wpem-modal-header-title">
                                                            <h3 class="wpem-modal-header-title-text"><?php _e('Watch video', 'congin'); ?></h3>
                                                        </div>
                                    ...
                                    if ($is_friend_share) :
                                    ?>
                                        <h3 class="wpem-heading-text"><?php _e('Share With Friends', 'congin'); ?></h3>
                                        <div class="wpem-share-this-event">
                                            <div class="wpem-event-share-lists">
                                                <?php do_action('single_event_listing_social_share_start'); ?>
                                                <div class="wpem-social-icon wpem-facebook">
                                                    <a href="https://www.facebook.com/sharer/sharer.php?u=<?php display_event_permalink(); ?>" title="Share this page on Facebook"><?php _e('Facebook', 'congin'); ?></a>
                                                </div>
                                                <div class="wpem-social-icon wpem-twitter">
                                                    <a href="https://twitter.com/share?text=twitter&url=<?php display_event_permalink(); ?>" title="Share this page on Twitter"><?php _e('Twitter', 'congin'); ?></a>
                                                </div>
                                                <div class="wpem-social-icon wpem-linkedin">
                                                    <a href="https://www.linkedin.com/sharing/share-offsite/?&url=<?php display_event_permalink(); ?>" title="Share this page on Linkedin"><?php _e('Linkedin', 'congin'); ?></a>
                                                </div>
                                                <div class="wpem-social-icon wpem-xing">
                                                    <a href="https://www.xing.com/spi/shares/new?url=<?php display_event_permalink(); ?>" title="Share this page on Xing"><?php _e('Xing', 'congin'); ?></a>
                                                </div>
                                                <div class="wpem-social-icon wpem-pinterest">
                                                    <a href="https://pinterest.com/pin/create/button/?url=<?php display_event_permalink(); ?>" title="Share this page on Pinterest"><?php _e('Pinterest', 'congin'); ?></a>
                                                </div>
