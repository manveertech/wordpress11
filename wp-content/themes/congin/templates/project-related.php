...
$related_pre_title = congin_get_mod( 'related_pre_title', 'EXPLORE PROJECTS' );
$related_title = congin_get_mod( 'related_title', 'OUR RECENT PROJECTS' );
$project_related_query = congin_get_mod( 'project_related_query', 7 );
$project_related_column = congin_get_mod( 'project_related_column', 3 );
