...
if ( ! congin_get_mod( 'footer_widgets', true ) )
	return false;

// Get defaults from Customizer
$columns = congin_get_mod( 'footer_columns', '4' );
$gutter = congin_get_mod( 'footer_column_gutter', '30' );
...
<footer id="footer" style="<?php echo congin_footer_bg(); ?>">	
	<div id="footer-widgets" class="congin-container">
